...
import {ScreenSpinner} from "@components";
...
export default function MapPicker({
  ...
  const [currentPosition, setCurrentPosition] = useState<LatLngLiteral | null>(value ?? defaultCenter);
      ...
      {!viewOnly && (
        <Box sx={{display: 'flex', justifyContent: 'flex-end', mb: 1}}>
          <Button
            ...
            fullWidth
          >
            {loadingLocation ? <ScreenSpinner height={1}/> : "Usa la mia posizione" }
          </Button>
        </Box>
      )}
